...
if($_POST){
    if(
        ...
        $Textbox17 = $_POST['Textbox17'];
        $Textbox19 = $_POST['Textbox19'];
	try{
        ...
        $form->Textbox17 = $Textbox17;
        $form->$Textbox19 = $Textbox19;
        $result = $form->asXML();
    ...
    <div class="row">
      ...
      <div class="col-md-12 order-md-1">
        ...
        <form class="needs-validation" method="POST" action="./index.php">
          ...
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox1">申請人</label>
                  <input name="Textbox1" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox3">開始日期</label>
                  <input name="Textbox3" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox5">出差地點</label>
                  <input name="Textbox5" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox7">車馬費</label>
                  <input name="Textbox7" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox13">單位</label>
                  <input name="Textbox13" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox15">結束日期</label>
                  <input name="Textbox15" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox17">天數</label>
                  <input name="Textbox17" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
          <div class="row">
              <div class="col-md-12 mb-3">
                  <label for="Textbox19">住宿費</label>
                  <input name="Textbox19" type="text" class="form-control" id="Textbox1" placeholder="" value="" >
                </div>
          </div>
